package com.yaonie.intelligent_assessment_server.springbootinit.utils;
...
public class ZhiPuUtils {
    ...
    public String doDrawPhoto(String message) {
        CreateImageRequest createImageRequest = CreateImageRequest.builder()
                ...
                .prompt(message)
                .build();
        ImageApiResponse image = clientV4.createImage(createImageRequest);
        String url = image.getData().getData().get(0).getUrl();
        log.info(url);
        return url;
    }
}
