package com.yaonie.intelligent.assessment.server.springbootinit.generate;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        ...
        outputPath = String.format("%s/generator/com.yaonie.intelligent.assessment.com.yaonie.intelligent.assessment.server.match.controller/%sController.java", projectPath, upperDataKey);
        // 生成
        ...
        outputPath = String.format("%s/generator/com.yaonie.intelligent.assessment.com.yaonie.intelligent.assessment.server.match.service/%sService.java", projectPath, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        ...
        outputPath = String.format("%s/generator/com.yaonie.intelligent.assessment.com.yaonie.intelligent.assessment.server.match.service/impl/%sServiceImpl.java", projectPath, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
