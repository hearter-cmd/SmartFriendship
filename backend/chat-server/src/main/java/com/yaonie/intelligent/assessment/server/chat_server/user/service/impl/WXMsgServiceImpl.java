...
public class WXMsgServiceImpl implements WXMsgService {
    ...
    public WxMpXmlOutTextMessage scan(WxMpXmlMessage wxMessage) {
        ...
        String getUserInfoUrl = wxMpService.getOAuth2Service().buildAuthorizationUrl(callback+"/api/wx/mp/callback", "snsapi_userinfo", "STATE");
    ...
    public void authorize(WxOAuth2UserInfo userInfo) {
        ...
        if (Objects.isNull(user)) {
            ...
            // 更新用户信息
            userService.updateUserById(UserAdepter.buildAuthorizeUser(userInfo), user.getId());
        }
        // 在等待队列中移除当前用户
