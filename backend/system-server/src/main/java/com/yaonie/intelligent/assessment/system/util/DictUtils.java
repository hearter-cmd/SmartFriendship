...
import com.yaonie.intelligent.assessment.server.common.model.constant.CacheConstants;
import com.yaonie.intelligent.assessment.server.common.util.StringUtils;
import com.yaonie.intelligent.assessment.system.core.redis.RedisCache;
...
public class DictUtils {
    ...
    public static List<SysDictData> getDictCache(String key) {
        List<SysDictData> arrayCache = SpringUtil.getBean(RedisCache.class).getCacheObject(getCacheKey(key));
    ...
    public static void clearDictCache() {
        Collection<String> keys = SpringUtil.getBean(RedisCache.class).keys(CacheConstants.SYS_DICT_KEY + "*");
