declare namespace API {
    ...
    type BaseQuestionContextDto_ = {
        code?: number
        data?: QuestionContextDto[]
        message?: string
    }
    ...
    type LoginUserVO = {
        id?: string | null // 注意：在TypeScript中，Long类型通常转换为number，除非你需要处理非常大的数字
        userAccount?: string
        email?: string
        sex?: number | null
        phone?: string
        ...
        tags?: string | null
        session?: string
        lastLoginTime?: string | null // TypeScript中的Date类型与JavaScript相同
        lastLeaveTime?: number | null // 在TypeScript中，Long类型通常转换为number
    ...
    type QuestionAddRequest = {
        appId?: number
        questionContent?: QuestionContextDto[]
    }

    type QuestionContextDto = {
        options?: Option[]
        title?: string
    }
    ...
    type getAnswerResultCountParams = {
        appId?: string
    }
